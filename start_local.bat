...
if !errorlevel! neq 0 (
    ...
    start "IDEP-Preprocessing" cmd /k call "%RUN_WITH_ENV%" python main.py
    popd
...
if !errorlevel! neq 0 (
    ...
    start "IDEP-PostProcessing" cmd /k call "%RUN_WITH_ENV%" python main.py
    popd
    timeout /t 2 /nobreak >nul
...
if !errorlevel! neq 0 (
    ...
    start "IDEP-PaddleOCR" cmd /k call "%RUN_WITH_ENV%" python -m uvicorn app.main:app --host 0.0.0.0 --port 8001
    popd
...
if !errorlevel! neq 0 (
    ...
    start "IDEP-GLM-OCR" cmd /k call "%RUN_WITH_ENV%" python -m uvicorn app.main:app --host 0.0.0.0 --port 8002
    popd
    timeout /t 3 /nobreak >nul
...
start "IDEP-Worker" cmd /k call "%RUN_WITH_ENV%" go run worker/main.go
popd
timeout /t 3 /nobreak >nul
...
if !errorlevel! neq 0 (
    ...
    start "IDEP-API-Gateway" cmd /k call "%RUN_WITH_ENV%" go run .
    popd
    timeout /t 5 /nobreak >nul
